...
const CustomCursor = ({ cursorVariant, springX, springY }) => {
  return (
    <motion.div
      className="hidden md:flex fixed top-0 left-0 w-8 h-8 bg-white rounded-full pointer-events-none z-[9999] mix-blend-difference items-center justify-center"
...
const Navbar = ({ setCursorVariant, setIsMenuOpen }) => (
  ...
  >
    <div 
      className="text-2xl font-black tracking-tighter uppercase flex items-center gap-2 md:cursor-none cursor-pointer"
    ...
    {isMenuOpen && (
      ...
      >
        <button 
          ...
          className="absolute top-6 right-6 p-4 hover:rotate-180 transition-transform duration-500 md:cursor-none cursor-pointer"
          onMouseEnter={() => setCursorVariant("hover")}
          onMouseLeave={() => setCursorVariant("default")}
        >
        ...
        <div className="flex flex-col items-start space-y-4">
          {["Start Game", "Inventory", "Skill Tree", "Lore", "Contact"].map((item, i) => (
            ...
            >
              <h2 
                className="text-6xl md:text-8xl font-black uppercase hover:text-lime-400 transition-colors md:cursor-none cursor-pointer"
      ...
      <div className="z-10 relative mix-blend-darken">
        ...
        <div className="overflow-hidden">
          <motion.h1 
            ...
            className="text-7xl md:text-[9rem] leading-[0.85] font-black uppercase tracking-tighter text-transparent text-stroke-black hover:text-lime-400 transition-colors duration-300 md:cursor-none cursor-pointer"
            onMouseEnter={() => setCursorVariant("hover")}
            onMouseLeave={() => setCursorVariant("default")}
...
const App = () => {
  ...
  return (
    <div className="bg-white text-black min-h-screen font-sans md:cursor-none cursor-auto selection:bg-lime-400 selection:text-black overflow-x-hidden">
      ...
      <CustomCursor cursorVariant={cursorVariant} springX={springX} springY={springY} />
      <NoiseOverlay />
      <Navbar setCursorVariant={setCursorVariant} setIsMenuOpen={setIsMenuOpen} />
      <FullScreenMenu isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} setCursorVariant={setCursorVariant} />
